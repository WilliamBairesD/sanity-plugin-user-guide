...
import { distExports } from "./index.mjs";
...
function LazyRefractor(props) {
  ...
  let t2;
  $[6] !== language || $[7] !== registered2 || $[8] !== value ? (t2 = language && registered2 && /* @__PURE__ */ jsx(Refractor, { inline: !0, language, value: String(value) }), $[6] = language, $[7] = registered2, $[8] = value, $[9] = t2) : t2 = $[9];
  let t3;
