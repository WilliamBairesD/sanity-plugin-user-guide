"use strict";
var uuid = require("@sanity/uuid"), icons = require("@sanity/icons"), React = require("react"), sanity = require("sanity"), jsxRuntime = require("react/jsx-runtime"), styledComponents = require("styled-components"), Markdown = require("react-markdown"), remarkGfm = require("remark-gfm"), router$1 = require("sanity/router");
...
var React__namespace = /* @__PURE__ */ _interopNamespaceCompat(React), Markdown__default = /* @__PURE__ */ _interopDefaultCompat(Markdown), remarkGfm__default = /* @__PURE__ */ _interopDefaultCompat(remarkGfm);
class UserGuideNodeBuilder {
  node;
  constructor(node) {
    this.node = { ...node, _key: uuid.uuid() };
  }
}
...
function requireDist() {
  ...
  var React2 = __toESM(React__namespace.default), { useRef, useEffect, isValidElement } = React2, _a, ReactSecretInternals = (
    //@ts-ignore
...
See https://react.dev/link/invalid-hook-call for tips about how to debug and fix this problem.`
    ...
    var React2 = React__namespace.default, Internals = {
      d: {
        f: noop3,
        r: function() {
          throw Error(
...
}, index = isClient ? React.useLayoutEffect : noop$1;
...
function useFloating(options) {
  ...
  const {
    ...
    open
  } = options, [data, setData] = React__namespace.useState({
    x: 0,
    y: 0,
    strategy,
    placement,
  ...
  }, []), referenceEl = externalReference || _reference, floatingEl = externalFloating || _floating, referenceRef = React__namespace.useRef(null), floatingRef = React__namespace.useRef(null), dataRef = React__namespace.useRef(data), hasWhileElementsMounted = whileElementsMounted != null, whileElementsMountedRef = useLatestRef(whileElementsMounted), platformRef = useLatestRef(platform2), openRef = useLatestRef(open), update = React__namespace.useCallback(() => {
  ...
  const refs = React__namespace.useMemo(() => ({
    ...
    floating: floatingEl
  }), [referenceEl, floatingEl]), floatingStyles = React__namespace.useMemo(() => {
    const initialStyles = {
      position: strategy,
      left: 0,
      top: 0
...
const arrow$1 = (options) => {
  ...
  ...arrow$1(options),
  options: [options, deps]
}), LayoutGroupContext = React.createContext({});
function useConstant(init) {
  const ref = React.useRef(null);
  return ref.current === null && (ref.current = init()), ref.current;
}
const isBrowser = typeof window < "u", useIsomorphicLayoutEffect = isBrowser ? React.useLayoutEffect : React.useEffect, PresenceContext = /* @__PURE__ */ React.createContext(null);
...
const isMotionValue = (value) => !!(value && value.getVelocity), valueTypes = [...dimensionValueTypes, color, complex], findValueType = (v) => valueTypes.find(testValueType(v)), MotionConfigContext = React.createContext({
...
function PopChild({ children, isPresent, anchorX, root }) {
  const id2 = React.useId(), ref = React.useRef(null), size2 = React.useRef({
    width: 0,
    height: 0,
    top: 0,
    left: 0,
    right: 0
  }), { nonce } = React.useContext(MotionConfigContext), composedRef = useComposedRefs(ref, children?.ref);
  ...
  }, [isPresent]), jsxRuntime.jsx(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size2, children: React__namespace.cloneElement(children, { ref: composedRef }) });
}
const PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, root }) => {
  const presenceChildren = useConstant(newChildrenMap), id2 = React.useId();
  let isReusedContext = !0, context2 = React.useMemo(() => (isReusedContext = !1, {
    id: id2,
    initial,
    isPresent,
    custom,
  ...
  return presenceAffectsLayout && isReusedContext && (context2 = { ...context2 }), React.useMemo(() => {
    presenceChildren.forEach((_, key2) => presenceChildren.set(key2, !1));
  }, [isPresent]), React__namespace.useEffect(() => {
    !isPresent && !presenceChildren.size && onExitComplete && onExitComplete();
  }, [isPresent]), mode === "popLayout" && (children = jsxRuntime.jsx(PopChild, { isPresent, anchorX, root, children })), jsxRuntime.jsx(PresenceContext.Provider, { value: context2, children });
};
function newChildrenMap() {
  return /* @__PURE__ */ new Map();
}
function usePresence(subscribe = !0) {
  const context2 = React.useContext(PresenceContext);
  if (context2 === null)
    return [!0, null];
  const { isPresent, onExitComplete, register } = context2, id2 = React.useId();
  React.useEffect(() => {
    if (subscribe)
      return register(id2);
  }, [subscribe]);
...
const AnimatePresence = ({ children, custom, initial = !0, onExitComplete, presenceAffectsLayout = !0, mode = "sync", propagate = !1, anchorX = "left", root }) => {
  const [isParentPresent, safeToRemove] = usePresence(propagate), presentChildren = React.useMemo(() => onlyElements(children), [children]), presentKeys = propagate && !isParentPresent ? [] : presentChildren.map(getChildKey), isInitialRender = React.useRef(!0), pendingPresentChildren = React.useRef(presentChildren), exitComplete = useConstant(() => /* @__PURE__ */ new Map()), [diffedChildren, setDiffedChildren] = React.useState(presentChildren), [renderedChildren, setRenderedChildren] = React.useState(presentChildren);
  ...
  return jsxRuntime.jsx(jsxRuntime.Fragment, { children: renderedChildren.map((child) => {
    ...
    return jsxRuntime.jsx(PresenceChild, { isPresent, initial: !isInitialRender.current || initial ? void 0 : !1, custom, presenceAffectsLayout, mode, root, onExitComplete: isPresent ? void 0 : onExit, anchorX, children: child }, key2);
  }) });
}, LazyContext = React.createContext({ strict: !1 }), featureProps = {
  animation: [
    "animate",
    "variants",
    "whileHover",
...
function useSVGProps(props, visualState, _isStatic, Component) {
  const visualProps = React.useMemo(() => {
    ...
    return buildSVGAttrs(state, visualState, isSVGTag(Component), props.transformTemplate, props.style), {
      ...state.attrs,
      style: { ...state.style }
    };
  }, [visualState]);
...
function useRender(Component, props, ref, { latestValues }, isStatic, forwardMotionProps = !1) {
  const visualProps = (isSVGComponent(Component) ? useSVGProps : useHTMLProps)(props, latestValues, isStatic, Component), filteredProps = filterProps(props, typeof Component == "string", forwardMotionProps), elementProps = Component !== React.Fragment ? { ...filteredProps, ...visualProps, ref } : {}, { children } = props, renderedChildren = React.useMemo(() => isMotionValue(children) ? children.get() : children, [children]);
...
const makeUseVisualState = (config) => (props, isStatic) => {
  const context2 = React.useContext(MotionContext), presenceContext = React.useContext(PresenceContext), make = () => makeState(config, props, context2, presenceContext);
...
const camelToDash = (str) => str.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(), optimizedAppearDataId = "framerAppearId", optimizedAppearDataAttribute = "data-" + camelToDash(optimizedAppearDataId), SwitchLayoutGroupContext = React.createContext({});
function useVisualElement(Component, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const visualElement = visualElementRef.current, initialLayoutGroupConfig = React.useContext(SwitchLayoutGroupContext);
  ...
  const optimisedAppearId = props[optimizedAppearDataAttribute], wantsHandoff = React.useRef(!!optimisedAppearId && !window.MotionHandoffIsComplete?.(optimisedAppearId) && window.MotionHasOptimisedAnimation?.(optimisedAppearId));
...
function createMotionComponent(Component, { forwardMotionProps = !1 } = {}, preloadedFeatures, createVisualElement) {
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    if (!isStatic && isBrowser) {
      ...
      MeasureLayout2 = layoutProjection.MeasureLayout, context2.visualElement = useVisualElement(Component, visualState, configAndProps, createVisualElement, layoutProjection.ProjectionNode);
    }
    return jsxRuntime.jsxs(MotionContext.Provider, { value: context2, children: [MeasureLayout2 && context2.visualElement ? jsxRuntime.jsx(MeasureLayout2, { visualElement: context2.visualElement, ...configAndProps }) : null, useRender(Component, props, useMotionRef(visualState, context2.visualElement, externalRef), visualState, isStatic, forwardMotionProps)] });
  }
  MotionDOMComponent.displayName = `motion.${typeof Component == "string" ? Component : `create(${Component.displayName ?? Component.name ?? ""})`}`;
  const ForwardRefMotionComponent = React.forwardRef(MotionDOMComponent);
  return ForwardRefMotionComponent[motionComponentSymbol] = Component, ForwardRefMotionComponent;
}
...
function createMotionProxy(preloadedFeatures, createVisualElement) {
  ...
  const componentCache = /* @__PURE__ */ new Map(), factory = (Component, options) => createMotionComponent(Component, options, preloadedFeatures, createVisualElement), deprecatedFactoryFunction = (Component, options) => (process.env.NODE_ENV !== "production" && warnOnce(!1, "motion() is deprecated. Use motion.create() instead."), factory(Component, options));
...
const context = React__namespace.default.createContext(!0);
function forbiddenInRender() {
  throw new Error("A function wrapped in useEffectEvent can't be called during rendering.");
}
const isInvalidExecutionContextForEventFunction = "use" in React__namespace.default ? () => {
  try {
    return React__namespace.default.use(context);
  } catch {
    return !1;
  }
} : () => !1;
function useEffectEvent(fn) {
  const ref = React__namespace.default.useRef(forbiddenInRender);
  return React__namespace.default.useInsertionEffect(() => {
    ref.current = fn;
  }, [fn]), (...args) => {
...
function createGlobalScopedContext(key2, defaultValue) {
  ...
  if (typeof document > "u") {
    const context2 = React.createContext(defaultValue);
...
function ThemeProvider(props) {
  const $ = distExports.c(15), parentTheme = React.useContext(ThemeContext), {
    children
  ...
  let t2;
  $[9] !== children || $[10] !== theme ? (t2 = /* @__PURE__ */ jsxRuntime.jsx(styledComponents.ThemeProvider, { theme, children }), $[9] = children, $[10] = theme, $[11] = t2) : t2 = $[11];
  let t3;
...
function useTheme_v2() {
  const $ = distExports.c(2), t0 = styledComponents.useTheme();
  let t1;
...
const StyledAvatar = /* @__PURE__ */ styledComponents.styled.div.withConfig({
  ...
  const color2 = t0 === void 0 ? "gray" : t0, status = t1 === void 0 ? "online" : t1, sizeProp = t2 === void 0 ? 1 : t2, {
    avatar
  } = useTheme_v2(), as = ReactIs.isValidElementType(asProp) ? asProp : "div", size2 = _getArrayProp(sizeProp), _sizeRem = (avatar.sizes[size2[0]] || avatar.sizes[0]).size, _radius = _sizeRem / 2, elementId = React.useId(), [arrowPosition, setArrowPosition] = React.useState(animateArrowFrom || arrowPositionProp || "inside"), [imageFailed, setImageFailed] = React.useState(!1), imageId = `avatar-image-${elementId}`;
  let t3, t4;
  ...
  let t10;
  $[22] !== color2 ? (t10 = /* @__PURE__ */ jsxRuntime.jsx(Arrow$1, { children: /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "11", height: "7", viewBox: "0 0 11 7", fill: "none", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M6.67948 1.50115L11 7L0 7L4.32052 1.50115C4.92109 0.736796 6.07891 0.736795 6.67948 1.50115Z", fill: color2 }) }) }), $[22] = color2, $[23] = t10) : t10 = $[23];
  let t11;
  ...
  let t13;
  return $[32] !== T0 || $[33] !== arrowPosition || $[34] !== as || $[35] !== color2 || $[36] !== ref || $[37] !== restProps || $[38] !== size2 || $[39] !== status || $[40] !== t10 || $[41] !== t11 || $[42] !== t12 || $[43] !== t8 || $[44] !== title ? (t13 = /* @__PURE__ */ jsxRuntime.jsxs(T0, { as, "data-as": t8, "data-ui": t9, ...restProps, $color: color2, $size: size2, "aria-label": title, "data-arrow-position": arrowPosition, "data-status": status, ref, title, children: [
    t10,
    t11,
    t12
...
const StyledButton = /* @__PURE__ */ styledComponents.styled.button.withConfig({
  ...
  $[57] !== IconComponent || $[58] !== IconRightComponent || $[59] !== boxProps || $[60] !== button || $[61] !== fontSize2 || $[62] !== justify || $[63] !== muted || $[64] !== space || $[65] !== text || $[66] !== textAlign || $[67] !== textWeight ? (t24 = (IconComponent || text || IconRightComponent) && /* @__PURE__ */ jsxRuntime.jsx(Box, { as: "span", ...boxProps, children: /* @__PURE__ */ jsxRuntime.jsxs(Flex, { as: "span", justify, gap: space, children: [
    IconComponent && /* @__PURE__ */ jsxRuntime.jsxs(Text, { size: fontSize2, children: [
      ...
      reactIsExports.isValidElementType(IconComponent) && /* @__PURE__ */ jsxRuntime.jsx(IconComponent, {})
    ] }),
    ...
    IconRightComponent && /* @__PURE__ */ jsxRuntime.jsxs(Text, { size: fontSize2, children: [
      ...
      reactIsExports.isValidElementType(IconRightComponent) && /* @__PURE__ */ jsxRuntime.jsx(IconRightComponent, {})
    ] })
...
function useElementSize(element) {
  const $ = distExports.c(3), [size2, setSize] = React.useState(null);
  let t0, t1;
  return $[0] !== element ? (t0 = () => {
    if (element)
...
const ElementQuery = React.forwardRef(function(props, forwardedRef) {
  ...
  const media = _media ?? theme.media, [element, setElement] = React.useState(null), width = useElementSize(element)?.border.width ?? window.innerWidth;
  let t0;
  if ($[4] !== media || $[5] !== width) {
  ...
  let t4;
  return $[13] !== children || $[14] !== max2 || $[15] !== min2 || $[16] !== restProps ? (t4 = /* @__PURE__ */ jsxRuntime.jsx("div", { "data-ui": "ElementQuery", ...restProps, "data-eq-max": max2, "data-eq-min": min2, ref: setElement, children }), $[13] = children, $[14] = max2, $[15] = min2, $[16] = restProps, $[17] = t4) : t4 = $[17], t4;
});
...
function LayerProvider(props) {
  ...
  const [, setChildLayers] = React.useState(t3), [size2, setSize] = React.useState(0), isTopLayer2 = size2 === 0;
  let t4;
...
function useLayer() {
  const $ = distExports.c(2), value = React.useContext(LayerContext);
  if (!value)
...
const StyledLayer = /* @__PURE__ */ styledComponents.styled.div.withConfig({
  ...
  const style = t0 === void 0 ? EMPTY_RECORD : t0, {
    zIndex,
    isTopLayer: isTopLayer2
  } = useLayer(), lastFocusedRef = React.useRef(null), ref = React.useRef(null), isTopLayerRef = React.useRef(isTopLayer2);
  let t1;
  ...
  }, t3 = [isTopLayer2, onActivate], $[7] = isTopLayer2, $[8] = onActivate, $[9] = t2, $[10] = t3) : (t2 = $[9], t3 = $[10]), React.useEffect(t2, t3);
  let t4;
...
const MotionCard$1 = styledComponents.styled(motion.create(Card)).withConfig({
  displayName: "MotionCard",
  componentId: "sc-ihg31s-0"
})`&:not([hidden]){display:flex;}flex-direction:column;width:max-content;min-width:min-content;will-change:transform;`, MotionFlex = styledComponents.styled(motion.create(Flex)).withConfig({
  ...
  let t11;
  $[48] !== arrow2 || $[49] !== arrowRef || $[50] !== arrowStyle ? (t11 = arrow2 && /* @__PURE__ */ jsxRuntime.jsx(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_POPOVER_ARROW_WIDTH, height: DEFAULT_POPOVER_ARROW_HEIGHT, radius: DEFAULT_POPOVER_ARROW_RADIUS }), $[48] = arrow2, $[49] = arrowRef, $[50] = arrowStyle, $[51] = t11) : t11 = $[51];
  let t12;
...
const ViewportOverlay = () => {
  ...
  const children = t38;
  let t39;
  $[120] !== animate || $[121] !== children ? (t39 = animate ? /* @__PURE__ */ jsxRuntime.jsx(AnimatePresence, { children }) : children, $[120] = animate, $[121] = children, $[122] = t39) : t39 = $[122];
  let t40;
...
function useDelayedState(initialState) {
  const $ = distExports.c(3), [state, setState] = React.useState(initialState), delayedAction = React.useRef(void 0);
  let t0;
...
const DEFAULT_TOOLTIP_ARROW_WIDTH = 15, DEFAULT_TOOLTIP_ARROW_HEIGHT = 6, DEFAULT_TOOLTIP_ARROW_RADIUS = 2, DEFAULT_TOOLTIP_DISTANCE = 4, DEFAULT_TOOLTIP_PADDING = 4, DEFAULT_FALLBACK_PLACEMENTS = {
...
}, MotionCard = styledComponents.styled(motion.create(Card)).withConfig({
  displayName: "MotionCard",
  ...
  let t9;
  $[30] !== arrow2 || $[31] !== arrowRef || $[32] !== arrowStyle ? (t9 = arrow2 && /* @__PURE__ */ jsxRuntime.jsx(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_TOOLTIP_ARROW_WIDTH, height: DEFAULT_TOOLTIP_ARROW_HEIGHT, radius: DEFAULT_TOOLTIP_ARROW_RADIUS }), $[30] = arrow2, $[31] = arrowRef, $[32] = arrowStyle, $[33] = t9) : t9 = $[33];
  let t10;
...
const StyledTooltip = styledComponents.styled(Layer).withConfig({
  ...
  const {
    ...
    refs,
    update
  } = useFloating(t10), arrowX = middlewareData.arrow?.x, arrowY = middlewareData.arrow?.y, originX = middlewareData["@sanity/ui/origin"]?.originX, originY = middlewareData["@sanity/ui/origin"]?.originY, tooltipId = React.useId(), [isOpen, setIsOpen] = useDelayedState(!1), delayGroupContext = useTooltipDelayGroup();
  let t11;
  ...
  const children = t38;
  let t39;
  $[131] !== animate || $[132] !== children ? (t39 = animate ? /* @__PURE__ */ jsxRuntime.jsx(AnimatePresence, { children }) : children, $[131] = animate, $[132] = children, $[133] = t39) : t39 = $[133];
  let t40;
...
const CustomButton = styledComponents.styled(Button).withConfig({
  ...
  let t9;
  return $[18] !== fontSize2 || $[19] !== handleFocus || $[20] !== icon || $[21] !== id2 || $[22] !== label || $[23] !== onClick || $[24] !== padding || $[25] !== restProps || $[26] !== selected || $[27] !== t7 || $[28] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(CustomButton, { "data-ui": "Tab", ...restProps, "aria-selected": t7, fontSize: fontSize2, icon, id: id2, mode: "bleed", onClick, onBlur: handleBlur, onFocus: handleFocus, padding, ref, role: "tab", selected, tabIndex: t8, text: label, type: "button" }), $[18] = fontSize2, $[19] = handleFocus, $[20] = icon, $[21] = id2, $[22] = label, $[23] = onClick, $[24] = padding, $[25] = restProps, $[26] = selected, $[27] = t7, $[28] = t8, $[29] = t9) : t9 = $[29], t9;
});
...
function AutocompleteOption(props) {
  ...
  const handleKeyDown = t1;
  let t2;
  return $[5] !== children || $[6] !== handleClick || $[7] !== handleKeyDown || $[8] !== id2 || $[9] !== selected ? (t2 = /* @__PURE__ */ jsxRuntime.jsx("li", { "aria-selected": selected, "data-ui": "AutocompleteOption", id: id2, role: "option", onClick: handleClick, onKeyDown: handleKeyDown, children }), $[5] = children, $[6] = handleClick, $[7] = handleKeyDown, $[8] = id2, $[9] = selected, $[10] = t2) : t2 = $[10], t2;
}
...
const AUTOCOMPLETE_LISTBOX_IGNORE_KEYS = ["Control", "Shift", "Alt", "Enter", "Home", "End", "PageUp", "PageDown", "Meta", "Tab", "CapsLock"], AUTOCOMPLETE_POPOVER_PLACEMENT = "bottom-start", AUTOCOMPLETE_POPOVER_FALLBACK_PLACEMENTS = ["bottom-start", "top-start"], DEFAULT_RENDER_VALUE = (value, option) => option ? option.value : value, DEFAULT_FILTER_OPTION = (query, option) => option.value.toLowerCase().indexOf(query.toLowerCase()) > -1, InnerAutocomplete = React.forwardRef(function(props, forwardedRef) {
  ...
  let t37;
  $[98] !== disabled || $[99] !== expanded || $[100] !== fontSize2 || $[101] !== handleOpenClick || $[102] !== openButton || $[103] !== openButtonBoxPadding || $[104] !== openButtonPadding || $[105] !== openButtonProps || $[106] !== readOnly ? (t37 = !disabled && !readOnly && openButton ? /* @__PURE__ */ jsxRuntime.jsx(Box, { "aria-hidden": expanded, padding: openButtonBoxPadding, children: /* @__PURE__ */ jsxRuntime.jsx(Button, { "aria-label": "Open", disabled: expanded, fontSize: fontSize2, icon: icons.ChevronDownIcon, mode: "bleed", padding: openButtonPadding, ...openButtonProps, onClick: handleOpenClick }) }) : void 0, $[98] = disabled, $[99] = expanded, $[100] = fontSize2, $[101] = handleOpenClick, $[102] = openButton, $[103] = openButtonBoxPadding, $[104] = openButtonPadding, $[105] = openButtonProps, $[106] = readOnly, $[107] = t37) : t37 = $[107];
  ...
  bb2: {
    ...
    if ($[114] !== activeValue || $[115] !== currentOption || $[116] !== filteredOptions || $[117] !== handleOptionSelect || $[118] !== id2 || $[119] !== listFocused || $[120] !== loading || $[121] !== renderOption) {
      ...
      $[123] !== activeValue || $[124] !== currentOption || $[125] !== handleOptionSelect || $[126] !== id2 || $[127] !== listFocused || $[128] !== loading || $[129] !== renderOption ? (t423 = (option_0) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsx(AutocompleteOption, { id: `${id2}-option-${option_0.value}`, onSelect: handleOptionSelect, selected: active, value: option_0.value, children: React.cloneElement(renderOption(option_0), {
          disabled: loading,
          selected: active,
      ...
      t412 = $[122];
    let t422;
    $[131] !== listBoxId || $[132] !== t412 ? (t422 = /* @__PURE__ */ jsxRuntime.jsx(Stack, { as: "ul", "aria-multiselectable": !1, "data-ui": "AutoComplete__resultsList", id: listBoxId, ref: listBoxElementRef, role: "listbox", space: 1, children: t412 }), $[131] = listBoxId, $[132] = t412, $[133] = t422) : t422 = $[133];
    let t432;
...
function useItems(t0) {
  ...
  if (maxLength && len > maxLength) {
    ...
    if ($[0] !== afterLength || $[1] !== beforeLength || $[2] !== collapse || $[3] !== expand || $[4] !== expandElementRef || $[5] !== len || $[6] !== open || $[7] !== popoverElementRef || $[8] !== rawItems || $[9] !== space) {
      ...
      let t4;
      $[16] !== space || $[17] !== t3 ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(Stack, { as: "ol", overflow: "auto", padding: space, space, children: t3 }), $[16] = space, $[17] = t3, $[18] = t4) : t4 = $[18];
      ...
      let t7;
      $[23] !== open || $[24] !== popoverElementRef || $[25] !== t4 || $[26] !== t6 ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(Popover, { constrainSize: !0, content: t4, open, placement: "top", portal: !0, ref: popoverElementRef, children: t6 }, "button"), $[23] = open, $[24] = popoverElementRef, $[25] = t4, $[26] = t6, $[27] = t7) : t7 = $[27], t1 = [...t2, t7, ...rawItems.slice(len - afterLength)], $[0] = afterLength, $[1] = beforeLength, $[2] = collapse, $[3] = expand, $[4] = expandElementRef, $[5] = len, $[6] = open, $[7] = popoverElementRef, $[8] = rawItems, $[9] = space, $[10] = t1;
    } else
      t1 = $[10];
    return t1;
  }
...
const StyledDialog = /* @__PURE__ */ styledComponents.styled(Layer).withConfig({
  ...
  const width = t2, ref = React.useRef(null), contentRef = React.useRef(null), layer = useLayer(), {
    isTopLayer: isTopLayer2
  ...
  let t10;
  $[22] !== header || $[23] !== labelId || $[24] !== onClose || $[25] !== showCloseButton || $[26] !== showHeader ? (t10 = showHeader && /* @__PURE__ */ jsxRuntime.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntime.jsxs(Flex, { align: "flex-start", padding: 3, children: [
...
const Dialog = React.forwardRef(function(props, ref) {
  ...
  const handleFocus = t12, labelId = `${id2}_label`, rootClickTimeoutRef = React.useRef(void 0);
  let t13;
  ...
  let t18;
  return $[67] !== portalProp || $[68] !== t17 ? (t18 = /* @__PURE__ */ jsxRuntime.jsx(Portal, { __unstable_name: portalProp, children: t17 }), $[67] = portalProp, $[68] = t17, $[69] = t18) : t18 = $[69], t18;
});
...
const MenuButton = React.forwardRef(function(props, forwardedRef) {
  ...
  let t17;
  $[28] !== buttonElement || $[29] !== handleBlur || $[30] !== handleItemClick || $[31] !== handleMenuClickOutside || $[32] !== handleMenuEscape || $[33] !== id2 || $[34] !== menuProp || $[35] !== shouldFocus ? (t17 = menuProp && React.cloneElement(menuProp, {
    "aria-labelledby": id2,
  ...
  const menu = t17;
  let t18;
  $[37] !== buttonProp || $[38] !== handleMouseDown || $[39] !== id2 || $[40] !== open ? (t18 = buttonProp && React.cloneElement(buttonProp, {
    "data-ui": "MenuButton",
    id: id2,
  ...
  let t24;
  return $[57] !== menu || $[58] !== open || $[59] !== popoverProps || $[60] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntime.jsx(Popover, { "data-ui": "MenuButton__popover", ...popoverProps, content: menu, open, children: t23 }), $[57] = menu, $[58] = open, $[59] = popoverProps, $[60] = t23, $[61] = t24) : t24 = $[61], t24;
});
...
`, StyledSkeleton$1 = /* @__PURE__ */ styledComponents.styled(Box).withConfig({
  ...
  const animated = t0 === void 0 ? !1 : t0, [visible, setVisible] = React.useState(!delay2);
  let t1, t2;
  $[5] !== delay2 ? (t1 = () => {
    if (!delay2)
      return;
  ...
  }, t2 = [delay2], $[5] = delay2, $[6] = t1, $[7] = t2) : (t1 = $[6], t2 = $[7]), React.useEffect(t1, t2);
  let t3;
...
styledComponents.styled(Flex).withConfig({
  displayName: "TextBox",
  componentId: "sc-1rr7rxo-0"
})`overflow-x:auto;`;
const StyledToast = styledComponents.styled(Card).withConfig({
...
styledComponents.styled(Card).withConfig({
...
const LoadingBarProgress = styledComponents.styled(Card).withConfig({
...
styledComponents.styled(Grid).withConfig({
  displayName: "StyledLayer",
...
const TreeContext = createGlobalScopedContext("@sanity/ui/context/tree", null), Tree = React.forwardRef(function(props, forwardedRef) {
  const $ = distExports.c(37);
  ...
  let t17;
  $[28] !== children || $[29] !== handleFocus || $[30] !== handleKeyDown || $[31] !== restProps || $[32] !== space ? (t17 = /* @__PURE__ */ jsxRuntime.jsx(Stack, { as: "ul", "data-ui": "Tree", ...restProps, onFocus: handleFocus, onKeyDown: handleKeyDown, ref, role: "tree", space, children }), $[28] = children, $[29] = handleFocus, $[30] = handleKeyDown, $[31] = restProps, $[32] = space, $[33] = t17) : t17 = $[33];
  let t18;
...
styledComponents.styled(Text).withConfig({
...
const MarkdownStyle = styledComponents.createGlobalStyle`
  .markdown {
  ...
  .markdown li {
    margin-bottom: 0.5em;
  }`, Page = ({ page: page2 }) => "component" in page2 ? /* @__PURE__ */ jsxRuntime.jsx(page2.component, {}) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
  /* @__PURE__ */ jsxRuntime.jsx(MarkdownStyle, {}),
  /* @__PURE__ */ jsxRuntime.jsx(Markdown__default.default, { className: "markdown", remarkPlugins: [remarkGfm__default.default], children: page2.markdown })
] }), Inspector = ({
  pages,
  documentType,
  documentId,
  ...
  return activePage ? /* @__PURE__ */ jsxRuntime.jsxs(Flex, { height: "fill", padding: 4, overflow: "auto", direction: "column", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(Flex, { align: "center", paddingY: 2, children: [
      /* @__PURE__ */ jsxRuntime.jsx(Card, { flex: 1, children: /* @__PURE__ */ jsxRuntime.jsx(Text, { size: 2, weight: "bold", muted: !0, children: "User guide" }) }),
      /* @__PURE__ */ jsxRuntime.jsx(
        Tooltip,
        {
          content: /* @__PURE__ */ jsxRuntime.jsx(Box, { padding: 2, children: /* @__PURE__ */ jsxRuntime.jsx(Text, { size: 1, children: "Open in guide" }) }),
          placement: "bottom",
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        Tooltip,
        {
          content: /* @__PURE__ */ jsxRuntime.jsx(Box, { padding: 2, children: /* @__PURE__ */ jsxRuntime.jsx(Text, { size: 1, children: "Close pane" }) }),
          placement: "bottom",
    ...
    /* @__PURE__ */ jsxRuntime.jsx(Page, { page: activePage })
  ] }) : /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {});
}, documentInspector = (pages) => sanity.defineDocumentInspector({
  name: "userGuide",
  ...
  component: (props) => React.createElement(Inspector, { pages, ...props })
});
...
const Error$1 = ({ error }) => /* @__PURE__ */ jsxRuntime.jsx(Card, { height: "fill", tone: "critical", padding: 4, children: /* @__PURE__ */ jsxRuntime.jsx(Flex, { height: "fill", align: "center", children: /* @__PURE__ */ jsxRuntime.jsxs(Container, { height: "fill", width: 2, children: [
  /* @__PURE__ */ jsxRuntime.jsx(Text, { size: 4, weight: "bold", children: "Encountered an error while reading the user guide structure" }),
  /* @__PURE__ */ jsxRuntime.jsx(Card, { marginTop: 4, padding: [3, 3, 4], tone: "critical", radius: 2, shadow: 2, children: /* @__PURE__ */ jsxRuntime.jsxs(Stack, { space: 5, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(Stack, { space: 3, children: [
      /* @__PURE__ */ jsxRuntime.jsx(Text, { size: 2, children: "Error:" }),
      /* @__PURE__ */ jsxRuntime.jsx(Text, { size: 2, style: { color: "var(--card-badge-critical-fg-color)" }, children: error.message })
    ] }),
    error.url && /* @__PURE__ */ jsxRuntime.jsx("a", { href: error.url, children: /* @__PURE__ */ jsxRuntime.jsx(Text, { size: 2, weight: "bold", style: { color: "var(--card-link-color)" }, children: "View documentation" }) })
  ] }) })
] }) }) }), MultiPage = ({
  slug,
  currentPage,
  ...
  /* @__PURE__ */ jsxRuntime.jsx(Page, { page: currentPage }),
  /* @__PURE__ */ jsxRuntime.jsxs(Flex, { paddingY: 4, justify: "space-between", wrap: "wrap-reverse", gap: 4, children: [
    previousPage ? /* @__PURE__ */ jsxRuntime.jsx(
      router$1.StateLink,
      {
        state: {
          page: slug,
    ...
    ) : /* @__PURE__ */ jsxRuntime.jsx(Card, {}),
    nextPage && /* @__PURE__ */ jsxRuntime.jsx(
      router$1.StateLink,
      {
        state: {
          page: slug,
  ...
  const { onClick, href } = router$1.useStateLink({
    state: { page: page2, subPage }
  });
  return /* @__PURE__ */ jsxRuntime.jsx(sanity.PreviewCard, { as: "a", href, onClick, radius: 2, selected, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { title, icon }) });
}, PageTree = ({ structure, basePage, activeSlug }) => /* @__PURE__ */ jsxRuntime.jsx(Stack, { as: "ul", space: 1, children: structure.map((node) => {
  switch (node._type) {
    case "jsxPage":
    case "markdownPage":
    case "multiPage":
    ...
    case "divider":
      return /* @__PURE__ */ jsxRuntime.jsx(Card, { borderBottom: !0 }, node._key);
    default:
      return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {});
  }
}) }), Tool = ({ userGuideStructure }) => {
  const pages = React.useMemo(() => getRootPages(userGuideStructure), [userGuideStructure]), { page: page2, subPage } = router$1.useRouterState((state) => state), currentPage = React.useMemo(() => pages.find((p) => p.slug === page2), [page2, pages]), currentSubPageIndex = React.useMemo(
    () => currentPage && "pages" in currentPage ? currentPage.pages.findIndex((p) => p.slug === subPage) : -1,
    [currentPage, subPage]
  );
  return Array.isArray(userGuideStructure) ? /* @__PURE__ */ jsxRuntime.jsxs(Flex, { height: "fill", align: "flex-start", children: [
    /* @__PURE__ */ jsxRuntime.jsx(Container, { height: "fill", width: 0, overflow: "auto", children: /* @__PURE__ */ jsxRuntime.jsxs(Card, { height: "fill", paddingX: 3, borderRight: !0, children: [
      /* @__PURE__ */ jsxRuntime.jsx(Box, { padding: 2, paddingTop: 5, marginBottom: 2, children: /* @__PURE__ */ jsxRuntime.jsx(Text, { size: 1, weight: "bold", muted: !0, children: "Guide" }) }),
      /* @__PURE__ */ jsxRuntime.jsx(PageTree, { structure: userGuideStructure, activeSlug: page2 })
    ] }) }),
    currentPage && currentPage._type === "multiPage" && /* @__PURE__ */ jsxRuntime.jsx(Container, { height: "fill", width: 0, overflow: "auto", children: /* @__PURE__ */ jsxRuntime.jsxs(Card, { height: "fill", paddingX: 3, borderRight: !0, children: [
      /* @__PURE__ */ jsxRuntime.jsx(Box, { padding: 2, paddingTop: 5, marginBottom: 2, children: /* @__PURE__ */ jsxRuntime.jsx(Text, { size: 1, weight: "bold", muted: !0, children: currentPage.title }) }),
      /* @__PURE__ */ jsxRuntime.jsx(PageTree, { structure: currentPage.pages, basePage: page2, activeSlug: subPage })
    ] }) }),
    /* @__PURE__ */ jsxRuntime.jsx(Container, { height: "fill", width: 20, overflow: "auto", children: /* @__PURE__ */ jsxRuntime.jsx(Flex, { padding: 4, direction: "column", align: "center", children: /* @__PURE__ */ jsxRuntime.jsxs(Container, { width: 2, children: [
      currentPage && currentPage._type !== "multiPage" && /* @__PURE__ */ jsxRuntime.jsx(Page, { page: currentPage }),
      currentPage && currentPage._type === "multiPage" && currentSubPageIndex >= 0 && /* @__PURE__ */ jsxRuntime.jsx(
        MultiPage,
        {
  ...
  ] }) : /* @__PURE__ */ jsxRuntime.jsx(Error$1, { error: userGuideStructure });
}, router = router$1.route.create("/", [
...
]), userGuidePlugin = sanity.definePlugin((options) => ({
...
exports.UserGuideError = UserGuideError;
exports.defineUserGuide = defineUserGuide;
exports.distExports = distExports;
exports.divider = divider;
exports.documentInspector = documentInspector;
exports.getDocumentPage = getDocumentPage;
exports.multiPage = multiPage;
exports.page = page;
exports.router = router;
exports.userGuidePlugin = userGuidePlugin;
