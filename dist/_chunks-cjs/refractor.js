"use strict";
var jsxRuntime = require("react/jsx-runtime"), index = require("./index.js"), React = require("react");
class Schema {
  /**
...
function parse$1(value) {
  ...
  let index2 = input.indexOf(","), start = 0, end = !1;
  for (; !end; ) {
...
function parseEntities(value, options) {
  ...
  let index2 = 0, lines = -1, queue = "", point, indent;
  ...
  for (index2--; ++index2 <= value.length; )
    if (character === 10 && (column = (indent ? indent[lines] : 0) || 1), character = value.charCodeAt(index2), character === 38) {
      ...
      if (reference) {
        ...
        characters = value.slice(start - 1, end), queue += characters, column += characters.length, index2 = end - 1;
    } else
...
function stringify(value, language) {
  ...
  if (Array.isArray(value)) {
    ...
    for (; ++index2 < value.length; )
      value[index2] !== null && value[index2] !== void 0 && value[index2] !== "" && result.push(
        /** @type {Element | Text} */
...
function filter(tree, options, test) {
  ...
  function preorder(node, index2, parentNode) {
    const children = [];
    if (!is(node, index2, parentNode)) return;
    if (parent(node)) {
      let childIndex = -1;
...
function visitParents(tree, test, visitor, reverse) {
  ...
  function factory(node, index2, parents) {
    ...
    function visit() {
      ...
      if ((!test || is(node, index2, parents[parents.length - 1] || void 0)) && (result = toResult(visitor(node, parents)), result[0] === EXIT))
        return result;
...
function mapChild(child, i, depth) {
  ...
  return isReactRefractorMarkerDataWithComponent(child.data) ? React.createElement(
    ...
    children
  ) : React.createElement(child.tagName, { key, className }, children);
}
...
function Refractor(props) {
  ...
  if (props.inline && (codeProps.style = { display: "inline" }, codeProps.className = className), props.plainText) {
    const code2 = /* @__PURE__ */ jsxRuntime.jsx("code", __spreadProps(__spreadValues({}, codeProps), { children: props.value }));
    return props.inline ? code2 : /* @__PURE__ */ jsxRuntime.jsx("pre", { className: preClass, children: code2 });
  }
  ...
  const value = ast.children.length === 0 ? props.value : ast.children.map(mapWithDepth(0)), code = /* @__PURE__ */ jsxRuntime.jsx("code", __spreadProps(__spreadValues({}, codeProps), { children: value }));
  return props.inline ? code : /* @__PURE__ */ jsxRuntime.jsx("pre", { className: preClass, children: code });
}
const hasLanguage = (lang) => refractor.registered(lang);
function LazyRefractor(props) {
  const $ = index.distExports.c(13), {
  ...
  let t1;
  $[2] !== language || $[3] !== registered2 || $[4] !== value ? (t1 = !(language && registered2) && /* @__PURE__ */ jsxRuntime.jsx("code", { children: value }), $[2] = language, $[3] = registered2, $[4] = value, $[5] = t1) : t1 = $[5];
  let t2;
  $[6] !== language || $[7] !== registered2 || $[8] !== value ? (t2 = language && registered2 && /* @__PURE__ */ jsxRuntime.jsx(Refractor, { inline: !0, language, value: String(value) }), $[6] = language, $[7] = registered2, $[8] = value, $[9] = t2) : t2 = $[9];
  let t3;
